...
Real-space regions in 4D-STEM datasets can be segmented and classified based on analysis of their Bragg spots through the use of virtual dark-field images [@Meng2016; @Bergh2020] or vector maps and co-occurence [@Savitzky2021]. 
...
Unsupervised machine learning algorithms do not require prior knowledge and comprise decomposition algroithms like non-negative matrix factorisation (NMF) [@Lee1999]. 
...
The PM workflow offers more flexibility than conventional template matching workflows and enables using representative experimental diffraction patterns as templates,  allowing mapping of unknwon crystal sturctures. 
...
The workflow is released open-source, and it can be further modified and readily applied to other material systems, for instance it has already been applied to to Al-Zn-Mg-Cu alloys [@Ryggetangen2025] and Al-Mg-Si-Cu alloys in a related publication [@sorhaug2026]. 