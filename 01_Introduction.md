...
Template matching is a much-used route which relies on comparing each recorded diffraction pattern to a list of simulated template patterns to find the best matching template, typically via cross correlation [@Rauch2010; @Cautaerts2022]. 
