...
The alloy contains two distinct and co-existing plate-shaped phases, namely $\uptheta$'-Al\textsubscript{2}Cu (tetragonal) and T\textsubscript{1}-Al\textsubscript{2}CuLi (hexagonal). 
Their space groups, lattice parameters and atomic positions are listed in \hl{Table 1}. 
...
Table 2 lists information on the crystal structures of the precipitate phases. 
