...
The alloy contains two distinct and co-existing plate-shaped phases, namely $\uptheta$'-Al\textsubscript{2}Cu and T\textsubscript{1}-Al\textsubscript{2}CuLi. 
...
$\uptheta'$ grows along $\lbrace001\rbrace$\textsubscript{Al} planes, while T\textsubscript{1} grows along $\lbrace111\rbrace$\textsubscript{Al} planes [@T1_abInitio; @inSitu_tp]. 
...
* - Phase
  - Al
  - $\uptheta$'-Al\textsubscript{2}Cu
  - T\textsubscript{1}-Al\textsubscript{2}CuLi
* - Space group
  - Fm$\Bar{3}$m (225)
  - I$\Bar{4}$m2 (119)
  - P6/mmm (191)
...
Previous studies on this specific alloy show that the precipitate types that typically form are $\upbeta''$, L, C, $\upbeta'$, $\upbeta'$\textsubscript{Cu}, Q', and Q [@Sunde2018; @Sunde2020]. 
...
\hl{Their} similar shapes and sizes make them difficult to discern based on morphology. 
...
* - Phase
  - Si network
  - $\upbeta''$-Mg\textsubscript{5}Al\textsubscript{2}Si\textsubscript{4}
  - $\upbeta'$-\text{Mg\textsubscript{9}Si\textsubscript{5}}
  - L 
  - C-Mg\textsubscript{4}AlSi\textsubscript{3+x}Cu\textsubscript{1-x}
  - Q'-
* - Space group
  - -
  - C2/m (12)
  - $P6\textsubscript{3}/m$ (176)
  - -
  - P$2_1$/m (11)
  - P$6_3$ (174)
* - Lattice parameter(s) [Å]
  - $a = 3.93$, $c = 4.05$
  - $a = 15.16$, $c = 6.74$, $\beta = \ang{105.3}$
  - $a = 7.15$, $c = 12.15$ 
  - -
  - $a = 10.32$, $b = 4.05$, $c = 8.10$, $\beta = \ang{100.9}$
  - $a = 10.32$, $c = 4.05$
* - Ref.
  - []
  - []
