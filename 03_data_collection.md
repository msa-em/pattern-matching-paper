...
The images were post-processed to reduce noise by blurring and enhance contrast, by applying a circular and centred band-pass mask (radius $\approx$1.3-1.8 Å$^{-1}$) to the fast Fourier transforms (FFTs) of the images, before calculating the inverse FFT. 
