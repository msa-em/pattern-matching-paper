...
The phase map and difference map are shown in Figure [](#fig_sim)(a) and (b), respectively, where two regions with mislabelled $\uptheta'$\textsubscript{$\langle$100$\rangle$} precipitates and a third region containing a mislabelled T\textsubscript{1} segment, are highlighted.
These areas are magnified and overlayed with the difference map in Figures [](#fig_sim)(c)-(e). 
...
The mislabelled segment inside the T\textsubscript{1} precipiate, shown in Figure [](#fig_sim)(e), is a common feature in all of the phase maps. 
...
Figure [](#fig_advanced) presents the phase map obtained after including overlap templates together with additional templates found by NMF-guided selection (approach C). 
...
The missing unfamiliar T\textsubscript{1} segment highlighted in Figure [](#fig_sim)(e) is now included and labelled as 'x'. 
...
:::{figure} ./figures/advanced.png :name: fig_advanced  
