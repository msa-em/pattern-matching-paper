---
title: Defining template patterns
numbering:
  enumerator: 3.%s
---

Three approaches of defining template patterns were used for the model dataset, as presented schematically in [](#fig_templates) and explained in the following. 
