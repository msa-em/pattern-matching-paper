...
Template matching the patterns with a binary disk (1.3) effectively enhances each Bragg disk, which makes it a beneficial step prior to thresholding or prior to peak finding to locate Bragg disks, as has also been noted in previous work [@francis2024]. 
