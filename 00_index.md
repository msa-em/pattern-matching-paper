...
The used raw data are available via the Zenodo repository [@Thronsen2022zenodo; @Sorhaug2024zenodo]. The used workflow is released open source and can be accessed via GitHub [@PMgithub]. 
